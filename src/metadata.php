...
$aModule = array(
    ...
    'files'          => array(
        ...
        'd3_importer_Application_Models_Exceptions_ImporterException'        => 'd3/importer/Application/Models/Exceptions/ImporterException.php',
        'd3_importer_Application_Models_Exceptions_ProfileException'        => 'd3/importer/Application/Models/Exceptions/ProfileException.php',
        'd3_importer_Application_Models_Exceptions_FileException'        => 'd3/importer/Application/Models/Exceptions/FileException.php',
        'd3_importer_Application_Models_Exceptions_ContentException'        => 'd3/importer/Application/Models/Exceptions/ContentException.php',
    ),
    'templates'      => array(
