...
<div id="liste">
    ...
    <form name="search" id="search" action="[{$oViewConf->getSelfLink()}]" method="post">
        ...
        <table cellspacing="0" cellpadding="0" border="0" width="100%">
            ...
            [{block name="d3_d3importer_views_admin_tpl_d3_picture_list_header"}]
                <tr class="listitem">
            ...
            [{block name="d3_d3importer_views_admin_tpl_d3_picture_list_items"}]
...
[{capture name="emptyCapture"}]
    <script type="text/javascript">
        ...
        if (parent.parent) {
            ...
            parent.parent.sMenuSubItem = "[{oxmultilang ident="D3_PICTURE_LIST_MENUSUBITEM"}]";
